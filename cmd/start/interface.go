...
import (
	...
	cmdRoot "github.com/dmorton-spirent/op-cli/cmd"
...
var startInterfaceCmd = &cobra.Command{
...
to quickly create a Cobra application.`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		opclient := cmdRoot.OPClientConnection()
...
func init() {
	startCmd.AddCommand(startInterfaceCmd)
	...
	startInterfaceCmd.Flags().BoolP("stats", "s", false, "Get interface statistics counters")
	startInterfaceCmd.Flags().BoolP("config", "c", false, "Get interface configuration parameters")
}
